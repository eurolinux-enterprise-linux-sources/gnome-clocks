/* timer.c generated by valac 0.32.0.61-f103e, the Vala compiler
...
static gboolean ___lambda48_ (ClocksTimerFace* self, GtkWidget* c);
static gboolean clocks_timer_face_count (ClocksTimerFace* self);
static gboolean ____lambda48__gtk_tick_callback (GtkWidget* widget, GdkFrameClock* frame_clock, gpointer self);
...
static gboolean ____lambda48__gtk_tick_callback (GtkWidget* widget, GdkFrameClock* frame_clock, gpointer self) {
	gboolean result;
	result = ___lambda48_ ((ClocksTimerFace*) self, widget);
	return result;
}
...
static void clocks_timer_face_add_tick (ClocksTimerFace* self) {
	...
	if (_tmp0_ == ((guint) 0)) {
		guint _tmp1_ = 0U;
		_tmp1_ = gtk_widget_add_tick_callback ((GtkWidget*) self, ____lambda48__gtk_tick_callback, g_object_ref (self), g_object_unref);
