/* clock.c generated by valac 0.32.0.61-f103e, the Vala compiler
...
GType clocks_panel_id_get_type (void) {
...
static void clocks_clock_base_init (ClocksClockIface * iface) {
	...
	if (!initialized) {
		...
		g_object_interface_install_property (iface, g_param_spec_enum ("panel-id", "panel-id", "panel-id", CLOCKS_TYPE_PANEL_ID, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE | G_PARAM_CONSTRUCT));
